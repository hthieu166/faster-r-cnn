...
class medico(imdb):
  def __init__(self, image_set, year, use_diff=False):
    ...
    assert os.path.exists(self._devkit_path), \
      'MEDICOdevkit path does not exist: {}'.format(self._devkit_path)
  ...
  def gt_roidb(self):
    ...
    gt_roidb = [self._load_medico_annotation(index)
...
if __name__ == '__main__':
  from datasets.medico import medico

  d = medico('trainval', '2018')
  res = d.roidb
